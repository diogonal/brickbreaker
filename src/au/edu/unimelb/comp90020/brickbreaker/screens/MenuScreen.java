...
import au.edu.unimelb.comp90020.brickbreaker.framework.util.Player;
...
public class MenuScreen extends ScreenAdapter {
	...
	private Button playButton, scoresButton, optionsButton, helpButton,
			quitButton;
	Vector3 touchPoint;
	...
	public MenuScreen(BrickBreaker game) {
		...
		playButton = new Button(Settings.TARGET_WIDTH / 2,
				Settings.TARGET_HEIGHT / 2, ButtonSize.XLARGE_RECTANGLE);
		scoresButton = new Button(Settings.TARGET_WIDTH / 2,
				Settings.TARGET_HEIGHT / 2 - 45, ButtonSize.XLARGE_RECTANGLE);
		optionsButton = new Button(Settings.TARGET_WIDTH / 2,
				Settings.TARGET_HEIGHT / 2 - 90, ButtonSize.XLARGE_RECTANGLE);
		helpButton = new Button(50 + ButtonSize.MEDIUM_SQUARE.getButtonWidth(),
				50, ButtonSize.MEDIUM_SQUARE);
		quitButton = new Button(Settings.TARGET_WIDTH
				- ButtonSize.MEDIUM_SQUARE.getButtonWidth() - 50, 50,
				ButtonSize.MEDIUM_SQUARE);
	...
	public void draw() {
		...
		game.batcher.draw(
				Assets.buttonMenu,
				scoresButton.position.x
						- ButtonSize.XLARGE_RECTANGLE.getButtonWidth() / 2,
				scoresButton.position.y
						- ButtonSize.XLARGE_RECTANGLE.getButtonHeight() / 2,
				ButtonSize.XLARGE_RECTANGLE.getButtonWidth(),
				ButtonSize.XLARGE_RECTANGLE.getButtonHeight());
		game.batcher.draw(
				Assets.buttonMenu,
				optionsButton.position.x
						- ButtonSize.XLARGE_RECTANGLE.getButtonWidth() / 2,
				optionsButton.position.y
						- ButtonSize.XLARGE_RECTANGLE.getButtonHeight() / 2,
				ButtonSize.XLARGE_RECTANGLE.getButtonWidth(),
				ButtonSize.XLARGE_RECTANGLE.getButtonHeight());
		...
		game.batcher.draw(
				Assets.quit,
				quitButton.position.x
						- ButtonSize.MEDIUM_SQUARE.getButtonWidth() / 2,
				quitButton.position.y
						- ButtonSize.MEDIUM_SQUARE.getButtonHeight() / 2,
				ButtonSize.MEDIUM_SQUARE.getButtonWidth(),
				ButtonSize.MEDIUM_SQUARE.getButtonHeight());
